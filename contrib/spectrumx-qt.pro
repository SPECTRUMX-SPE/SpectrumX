...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/spectrumx-cli.cpp \
           src/spectrumx-tx.cpp \
           src/spectrumx.cpp \
           src/db.cpp \
           ...
           src/qt/spectrumx.cpp \
           src/qt/spectrumxstrings.cpp \
...
RESOURCES += src/qt/spectrumx.qrc src/qt/spectrumx_locale.qrc

TRANSLATIONS += src/qt/locale/spectrumx_bg.ts \
                src/qt/locale/spectrumx_de.ts \
                src/qt/locale/spectrumx_en.ts \
                src/qt/locale/spectrumx_es.ts \
                src/qt/locale/spectrumx_fi.ts \
                src/qt/locale/spectrumx_fr.ts \
                src/qt/locale/spectrumx_it.ts \
                src/qt/locale/spectrumx_ja.ts \
                src/qt/locale/spectrumx_pl.ts \
                src/qt/locale/spectrumx_pt.ts \
                src/qt/locale/spectrumx_ru.ts \
                src/qt/locale/spectrumx_sk.ts \
                src/qt/locale/spectrumx_sv.ts \
                src/qt/locale/spectrumx_vi.ts \
                src/qt/locale/spectrumx_zh_CN.ts \
                src/qt/locale/spectrumx_zh_TW.ts
