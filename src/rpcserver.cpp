...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop spectrumx server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "spectrumx server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* spectrumx features */
        {"spectrumx", "masternode", &masternode, true, true, false},
        {"spectrumx", "listmasternodes", &listmasternodes, true, true, false},
        {"spectrumx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"spectrumx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"spectrumx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"spectrumx", "masternodedebug", &masternodedebug, true, true, false},
        {"spectrumx", "startmasternode", &startmasternode, true, true, false},
        {"spectrumx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"spectrumx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"spectrumx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"spectrumx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"spectrumx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"spectrumx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"spectrumx", "mnbudget", &mnbudget, true, true, false},
        {"spectrumx", "preparebudget", &preparebudget, true, true, false},
        {"spectrumx", "submitbudget", &submitbudget, true, true, false},
        {"spectrumx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"spectrumx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"spectrumx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"spectrumx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"spectrumx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"spectrumx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"spectrumx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"spectrumx", "checkbudgets", &checkbudgets, true, true, false},
        {"spectrumx", "mnsync", &mnsync, true, true, false},
        {"spectrumx", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> spectrumx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:34442/\n";
}
