...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "spectrumx main-net";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1553202488;
        genesis.nBits = 0x1e0ffff0;  // 00000ffff0000000000000000000000000000000000000000000000000000000
        genesis.nNonce = 1541854;
        hashGenesisBlock = genesis.GetHash();
if (genesis.nNonce != 0) {
           assert(hashGenesisBlock == uint256("0x000007cec73a53b17c0eac0340bceb6243b25ce057c96cd7d364f4ff1f7e380e"));
           assert(genesis.hashMerkleRoot == uint256("0xc3c1de025107f3255383354f5c7e9a973270dcbf75c081e089296cfeaddb1c7a"));
        }
        ...
        //vSeeds.push_back(CDNSSeedData("", ""));
          ...
          vSeeds.push_back(CDNSSeedData("107.175.32.147", "107.175.32.147"));
	      vSeeds.push_back(CDNSSeedData("107.174.70.219", "107.174.70.219"));
		  vSeeds.push_back(CDNSSeedData("107.175.32.183", "107.175.32.183"));
          vSeeds.push_back(CDNSSeedData("107.173.137.147", "107.173.137.147"));
          vSeeds.push_back(CDNSSeedData("173.212.231.29", "173.212.231.29"));
                  
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 63);  // R
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 125); // r
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 121);     // +128
        ...
        strSporkKey = "03af6790aa84ef3db59435d8873370145c22e29d6a1a66ef53f477fcb8cebd0485";
        strMasternodePoolDummyAddress = "SsJVWUkt6HtSCY2SaJ2akeyJUg8bg1hW3S";
        nStartMasternodePayments = genesis.nTime + (60); // 60 segs after genesis creation
