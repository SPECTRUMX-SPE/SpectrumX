...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("spectrumx Core spectrumx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  spectrumx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded spectrumx transaction") + "\n" +
                               "  spectrumx-tx [options] -create [commands]   " + _("Create hex-encoded spectrumx transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded spectrumx transaction
