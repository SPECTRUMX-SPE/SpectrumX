...
#if defined(NDEBUG)
#error "spectrumx cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uspe) are considered zero fee (for relaying and mining)
...
{
    RenameThread("spectrumx-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // SPE: We use certain sporks during IBD, so check to see if they are
