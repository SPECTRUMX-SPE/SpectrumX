...
/** Utility functions used by the spectrumx Qt UI.
 */
namespace GUIUtil
{
...
// Render REL addresses in monospace font
...
// Parse "spectrumx:" URI into recipient object, return true on successful parsing
