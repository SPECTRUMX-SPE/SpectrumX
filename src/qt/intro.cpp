...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("spectrumx Core"),
     ...
     * override -datadir in the spectrumx.conf file in the default data directory
     * (to be consistent with spectrumxd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
