                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("spectrumx") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and spectrumx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About spectrumx"), this);
    aboutAction->setStatusTip(tr("Show information about spectrumx"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for spectrumx"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SPE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SPE addresses"));
    ...
    openAction->setStatusTip(tr("Open a spectrumx: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the spectrumx help message to get a list with possible spectrumx command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("spectrumx client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to spectrumx network", "", count));
}
...
{
    QString strTitle = tr("spectrumx"); // default title
