Contributing to spectrumx Core
==================================

The spectrumx Core project operates an open contributor model where anyone is
...
The following applies to code changes to the spectrumx Core project, and is not to be
confused with overall spectrumx Network Protocol consensus changes.

Whether a pull request is merged into spectrumx Core rests with the project merge
...
Patches that change spectrumx consensus rules are considerably more involved than
...
Where a patch set proposes to change the spectrumx consensus, it must have been
...
The project leader is the release manager for each spectrumx Core release.
