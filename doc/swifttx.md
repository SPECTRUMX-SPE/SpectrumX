...
This mechanism has been integrated into Bitcore-Node-spectrumx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/spectrumx/insight-api-spectrumx#web-socket-api](https://github.com/spectrumx/insight-api-spectrumx#web-socket-api)
* API: [https://github.com/spectrumx/insight-api-spectrumx#swifttx-transactions](https://github.com/spectrumx/insight-api-spectrumx#swifttx-transactions)
...
By default, the spectrumx Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the spectrumx Core daemon:
