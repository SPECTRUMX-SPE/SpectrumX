...
#   c) node1 mines 32 blocks, so now node 0 has 500000REL, node 1 has 4250REL, node2 has none.
#   d) node0 sends 601 SPE to node2, in two transactions (301 SPE, then 300 SPE).
